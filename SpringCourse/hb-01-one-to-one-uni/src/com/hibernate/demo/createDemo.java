...
//			
			...
			Instructor tempInstructor = new Instructor("Rachana", "Katakam", "rachana@ibm.com"); // create student object
			InstructorDetail tempInstructorDetail = new InstructorDetail("www.rachana.com", "Love 2 code");
			// start a transaction
